...
_(model 7 bias = 1.41%, variance = 20.96% | training accuracy = , validation accuracy = )_  
...
_(model 9 bias = 5.69%, variance = 8.71% | training accuracy = , validation accuracy = )_  
...
_(model 14 bias = 18.84%, variance = 0.34% | training accuracy = , validation accuracy = )_  
...
_(model 15 w/ same padding: bias = 16.40%, variance = 0.44% | training accuracy = , validation accuracy = )_  
...
_(model 16 bias = 9.75%, variance = 1.55% | training accuracy = , validation accuracy = )_  
...
_(model 17 bias = 7.66%, variance = 1.58% | training accuracy = , validation accuracy = | avg time per epoch = 235s)  
(model 17 gpu bias = 7.65%, variance = 1.79% | training accuracy = , validation accuracy = | avg time per epoch = 14s)_  
...
_(model 18 bias = 7.14%, variance = 4.08% | training accuracy = , validation accuracy = )_  
...
_(model 20 bias = 9.72%, variance = 4.32% | training accuracy = , validation accuracy = )_  
...
_(model 21 bias = 6.17%, variance = 1.14% | training accuracy = , validation accuracy = )_  
...
_For model 21, the training epoch corresponding to the lowest validation loss has: (bias = 7.39%, variance = 0.32% | training accuracy = , validation accuracy = )_
...
...
###### TODO
- [ ] add acc alongside bias and variance
- [ ] finish prog summary 
