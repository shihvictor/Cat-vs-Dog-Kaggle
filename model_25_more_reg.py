...
def model_25_more_reg(input_shape):
    """
    Keras model. from model_25 .6->.7 dropout in first dense layer
    ...
    model = Model(inputs=X_input, outputs=X, name='CatDogModel_25_more_reg')
    return model